...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        # Pet Image Label is NOT a Dog
            ...
            if results_dic[key][4] == 0 and results_dic[key][3]:
    ...
    if results_stats_dic['n_images'] or results_stats_dic['n_match']==0:
    ...
    if results_stats_dic['n_dogs_img'] or results_stats_dic['n_correct_dogs'] ==0:
    ...
    if results_stats_dic['n_dogs_img'] or results_stats_dic['n_correct_breed'] == 0:
